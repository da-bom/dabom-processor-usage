...
class UsagePersistKafkaProducerTest {

    @InjectMocks private UsagePersistKafkaProducer producer;

    @Mock private KafkaTemplate<String, String> kafkaTemplate;
    @Mock private KafkaEventMessageSupport kafkaEventMessageSupport;

    @Test
    @DisplayName("publish serializes the envelope and sends it to the usage-persist topic")
